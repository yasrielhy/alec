      ...
      <main>
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 place-items-center gap-1">
          ...
          <p className="pb-10 text-4xl font-bold text-center text-blue-800 lg:text-3xl">Axle Load Calculation</p>
            <p className="p-3 text-2xl text-center font-light text-black dark:text-yellow-50 lg:w-5/6 lg:pb-0 lg:text-lg lg:p-0 lg:pl-0 lg:pr-0">Kelebihan muatan pada umumnya terdapat pada mobil barang. Berikan beban kendaraanmu sesuai kemampuan, gunakan aplikasi tersebut untuk mengetahuinya.</p>
          </div>
        ...
        <div className="lg:items-center lg:flex lg:flex-row-reverse lg:justify-center">
          <div className="flex flex-col justify-center items-center p-10">
            ...
            <p className="p-3 text-2xl leading-10 text-center font-light text-black dark:text-yellow-50 lg:w-5/6 lg:pb-0 lg:text-lg lg:text-left lg:p-0 lg:pl-0 lg:pr-0">Mulailah perhitungan ini secara gratis dengan klik <span className="font-bold cursor-pointer" type="button" onClick={() => router.push('/calc')}>tautan</span> ini</p>
          </div>
          <div className="flex flex-col justify-center items-center p-10">
